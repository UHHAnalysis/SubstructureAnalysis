#if !defined(SubstructureCycleNew_H) && !defined(__CINT__)
#define SubstructureCycleNew_H

#include "SFrameTools/include/AnalysisModule.h"
#include <memory>

/**
 *   @short Substructure of an analysis cycle, new version using AnalysisModule
 */
class SubstructureCycleNew : public AnalysisModule {
public:
