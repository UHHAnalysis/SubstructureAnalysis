...
#include "include/SubstructureJetHTPreSelectionCycle.h"
...
ClassImp( SubstructureJetHTPreSelectionCycle );

SubstructureJetHTPreSelectionCycle::SubstructureJetHTPreSelectionCycle()
  : AnalysisCycle() {
...
void SubstructureJetHTPreSelectionCycle::BeginCycle() throw( SError ) 
{
...
void SubstructureJetHTPreSelectionCycle::EndCycle() throw( SError ) 
{
...
void SubstructureJetHTPreSelectionCycle::BeginInputData( const SInputData& id ) throw( SError ) 
{
...
void SubstructureJetHTPreSelectionCycle::EndInputData( const SInputData& id ) throw( SError ) 
{
  AnalysisCycle::EndInputData( id );
}

void SubstructureJetHTPreSelectionCycle::BeginInputFile( const SInputData& id ) throw( SError ) 
{
...
void SubstructureJetHTPreSelectionCycle::ExecuteEvent( const SInputData& id, Double_t weight ) throw( SError ) 
{
